		...
		<div id="content">
          ...
          <div data-ss-widget="carousel" data-ss-options="autoscroll">
						<div data-ss-component="item">
							...
							<img src="<?php echo $base_url.'img/newcrop/c5.png' ?>" alt="Another Round Boat" />
						</div>
						<div data-ss-component="item">
							<aside class="courtesy">Image Courtesy of Scott Historical Photos</aside>
							<img src="<?php echo $base_url.'img/newcrop/c6.png' ?>" alt="Another Round Boat" />
						</div>
						<div data-ss-component="item">
							<img src="<?php echo $base_url.'img/newcrop/c1.png' ?>" alt="Partiers" />
						</div>
						<div data-ss-component="item">
							<aside class="courtesy">Image Courtesy of Scott Historical Photos</aside>
							<img src="<?php echo $base_url.'img/newcrop/c7.png' ?>" alt="Marina" />
						</div>
						<div data-ss-component="item"><img src="<?php echo $base_url.'img/newcrop/c3.png' ?>" alt="Chris" /></div>
						<div data-ss-component="item"><img src="<?php echo $base_url.'img/newcrop/c2.png' ?>" alt="Fun" /></div>
						<div data-ss-component="item"><img src="<?php echo $base_url.'img/newcrop/c8.png' ?>" alt="Jerry" /></div>
						<div data-ss-component="item"><img src="<?php echo $base_url.'img/newcrop/c4.png' ?>" alt="Sailing" /></div>
          </div>
				</section>
				<section class="five columns">
					...
					<p>Charters are available on Wednesdays (days and evenings) and Saturday (days only) by appointment.</p>

				</section>
			</div>
			<img src="<?php echo $base_url.'img/rope.png' ?>" class="rope" />
			<h2 class="row">Where We Are</h2>
			<div id="location" class="row rounded">
				<section class="seven columns">
					<figure>
						<a href="<?php echo $base_url.'img/map.jpg' ?>" target="_blank"><img src="<?php echo $base_url.'img/map.jpg' ?>" class="shadow" alt="Map" /></a>
					</figure>
				</section>
				<section class="five columns">
					<p>We are located in Erie, PA on the shores of Presque Isle Bay, just east of Liberty Park.</p>
				</section>
			</div>
			<img src="<?php echo $base_url.'img/rope.png' ?>" class="rope" />
